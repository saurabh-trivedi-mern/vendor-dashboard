    ...
    <div className="mx-auto bg-white p-6 rounded-lg shadow space-y-6">
      ...
      <div className="grid grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="border border-blue-200 bg-blue-50 p-6 pb-8 rounded-lg">
            <div className="flex flex-col">
              ...
              <div className="flex justify-center">
                <button
                  className="mt-4 px-4 py-1 text-sm bg-yellow-200 text-yellow-800 rounded-full font-medium"
                  disabled
                >
                  Coming Soon
                </button>
        ...
        <div className="space-y-6">
          ...
          {/* Recent Activity */}
          <div className="border-1 border-gray-300 bg-white p-4 rounded-lg shadow-sm">
